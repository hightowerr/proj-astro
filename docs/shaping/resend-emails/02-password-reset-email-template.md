...
- Logo: text-only `<span>` ("Astro"), not an image — avoids external asset hosting
...
- **Body:** `You requested a password reset for your Astro account. Click the button below to choose a new password.`
...
You requested a password reset for your Astro account.
...
### Mockup Specs
- **Width:** 600px max
- **Header:** "Astro" text logo, 22px, weight 800, color `#001e40`
